    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theType', models.IntegerField(choices=[(0, 'Front End'), (1, 'Back End'), (2, 'Full Stack'), (3, 'Organization')], default=0)),
                ('theStatus', models.IntegerField(choices=[(0, 'Current'), (1, 'Past')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updateType', models.IntegerField(choices=[(0, 'Current'), (1, 'Past'), (2, 'All'), (3, 'Resume'), (4, 'Contact')], default=0)),
